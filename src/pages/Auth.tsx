...
const Auth = () => {
  ...
  const sign = async (event: React.SyntheticEvent) => {
    event.preventDefault()
    if(isLogin) {
      ...
      >
        ...
        <Box component="form">
          ...
          {isLogin ? (
            ...
            <>
              <InputLabel sx={{ mt: 1 }}>Повторите пароль</InputLabel>
              <OutlinedInput
                placeholder="Повторите пароль"
                id="outlined-adornment-password"
                type={showPassword ? "text" : "password"}
...
>>>>>>> 37a71c0 (authStore authService login/checkAuth)
